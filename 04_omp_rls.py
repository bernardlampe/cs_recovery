...
if __name__ == "__main__":
    ...
    for db in [None, 20]:
        ...
        plt_error(x_h, x_f, 'sparsity_term, k = 20', alg='omp_rls')

        x_h = omp_rls(A, y, percent_term, 0.99)
        plt_error(x_h, x_f, 'percent_term, p = 0.9999', alg='omp_rls')

        x_h = omp_rls(A, y, epsilon_term, 0.00001)
        plt_error(x_h, x_f, 'epsilon_term, k = 0.00001', alg='omp_rls')
