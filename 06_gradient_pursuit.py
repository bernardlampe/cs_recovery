...
if __name__ == "__main__":
    ...
    for db in [None, 20]:
        ...
        plt_error(x_h, x_f, 'sparsity_term, k = 20', alg='gradient_pursuit')

        x_h = gradient_pursuit(y, A, percent_term, 0.99)
        plt_error(x_h, x_f, 'percent_term, p = 0.99', alg='gradient_pursuit')

        x_h = gradient_pursuit(y, A, epsilon_term, 0.00001)
        plt_error(x_h, x_f, 'epsilon_term, e = 0.00001', alg='gradient_pursuit')
